                    ...
                    <Toolbar>
                        ...
                        {!isEmpty &&
                          resultsOptions.map(item => 
                            <Button color="inherit"><Link className="linkBase" to={item.link}>{item.name}</Link></Button>
                          )
                        }
                        <Button color="inherit"><Link className="linkBase" to='login'>Login</Link></Button>
                        {auth && (
                          <div>
                            <IconButton
